...
//    Both PUNKS_UPDATER_PUBLIC_KEY and PUNKS_UPDATER_ENDPOINT are required -
...
const updaterPubkey = process.env.PUNKS_UPDATER_PUBLIC_KEY;
const updaterEndpoint = process.env.PUNKS_UPDATER_ENDPOINT;

const missing = [];
if (!updaterPubkey) missing.push("PUNKS_UPDATER_PUBLIC_KEY");
if (!updaterEndpoint) missing.push("PUNKS_UPDATER_ENDPOINT");
if (missing.length > 0) {
  console.error(
