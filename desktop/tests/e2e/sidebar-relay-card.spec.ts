...
async function setChannelsReadError(page: Page, error: string | null) {
  await page.evaluate((nextError) => {
    const testWindow = window as Window & {
      __PUNKS_E2E__?: { mock?: { channelsReadError?: string } };
    };
    ...
    if (nextError === null) {
      delete testWindow.__PUNKS_E2E__.mock.channelsReadError;
      return;
    }

    testWindow.__PUNKS_E2E__.mock.channelsReadError = nextError;
  }, error);
}
