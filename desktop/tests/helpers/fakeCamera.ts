  ...
  return page.addInitScript(
    (cameraOptions) => {
      ...
      const testWindow = window as Window & {
        __PUNKS_E2E_CAMERA_CONSTRAINTS__?: MediaStreamConstraints[];
        __PUNKS_E2E_CAMERA_REQUEST_COUNT__?: number;
        __PUNKS_E2E_RELEASE_CAMERA__?: () => void;
      };
      testWindow.__PUNKS_E2E_CAMERA_CONSTRAINTS__ = [];
      testWindow.__PUNKS_E2E_CAMERA_REQUEST_COUNT__ = 0;
      let releaseCamera: (() => void) | null = null;
      testWindow.__PUNKS_E2E_RELEASE_CAMERA__ = () => {
        releaseCamera?.();
        releaseCamera = null;
      };
      ...
      Object.defineProperty(mediaDevices, "getUserMedia", {
        ...
        value: async (constraints: MediaStreamConstraints) => {
          testWindow.__PUNKS_E2E_CAMERA_CONSTRAINTS__?.push(constraints);
          testWindow.__PUNKS_E2E_CAMERA_REQUEST_COUNT__ =
            (testWindow.__PUNKS_E2E_CAMERA_REQUEST_COUNT__ ?? 0) + 1;
          if (
            testWindow.__PUNKS_E2E_CAMERA_REQUEST_COUNT__ <=
