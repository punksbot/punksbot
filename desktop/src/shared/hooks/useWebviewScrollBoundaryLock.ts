...
const CONVERSATION_SCROLL_SELECTOR = "[data-punks-conversation-scroll]";
 ...
 *
 * Punks is laid out as fixed-height nested panes. On macOS, a wheel/trackpad
 ...
 * boundaries, only containers marked with `data-punks-conversation-scroll` are
