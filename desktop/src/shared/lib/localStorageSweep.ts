...
export const LOCAL_STORAGE_SWEEP_RULES: readonly LocalStorageSweepRule[] = [
  { keyPrefix: "punks-channel-messages.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "punks-channels.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "punks-observed-unread.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "punks-sidebar-skeleton-shape.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "punks-timeline-skeleton-shape.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "punks-user-labels.v1:", maxAgeMs: 14 * DAY_MS },
  // Do not add punks-self-profile.v1: here. It is the load-bearing offline
