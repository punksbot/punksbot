 ...
 *
 * URL inputs (`https://`, `http://`, `punks-local://join`) always carry a
 ...
 *  - `punks-local://join?relay=<wsUrl>&code=<code>` → `{ relayWsUrl, code }`
