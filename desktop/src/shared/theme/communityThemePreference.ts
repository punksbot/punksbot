...
const STORAGE_KEY_PREFIX = "punks-community-theme.v1";
const OUTBOX_KEY_PREFIX = "punks-community-theme-outbox.v1";
const MIGRATION_KEY_PREFIX = "punks-community-theme-migrated.v1";
