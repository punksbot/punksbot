...
/**
 * Punks sidebar-gradient stop tokens, keyed by theme name. The actual custom
 ...
 */
export const PUNKS_GRADIENT_STOPS: Record<
  string,
  { top: string; bottom: string }
> = {
  punks: {
    top: "var(--punks-gradient-light-top)",
    bottom: "var(--punks-gradient-light-bottom)",
  },
  "punks-dark": {
    top: "var(--punks-gradient-dark-top)",
    bottom: "var(--punks-gradient-dark-bottom)",
  },
};
...
function SystemPreferencePreviewSvg({
  ...
  const lightGradientId = `${clipBase}-punks-light`;
  const darkGradientId = `${clipBase}-punks-dark`;
