...
export const TEXTURED_SURFACE_CLASS =
  "punks-card-textured relative isolate rounded-none border-0 bg-transparent p-[var(--punks-card-textured-safe-inset)] shadow-none";
...
export function texturedSurfaceClasses({
  ...
  return cn(
    ...
    tone === "dark" && "punks-card-textured-dark",
    size === "compact" && "punks-card-textured-compact",
  );
}
 ...
 * - Default padding is the safe inset (`--punks-card-textured-safe-inset`),
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          variant === "textured" &&
            textureTone === "dark" &&
            "punks-card-textured-dark",
          variant === "textured" &&
            textureSize === "compact" &&
            "punks-card-textured-compact",
        )}
        {...props}
      />
    );
