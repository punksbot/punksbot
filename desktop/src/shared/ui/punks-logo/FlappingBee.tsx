...
/**
 * The Punks bee mark with flapping wings. Geometry is identical to the static
 * {@link PunksMark} (v8 final keyframe) — the same silhouette, rendered in
 * `currentColor` so it tints per-theme — with the wing-flap keyframes (ported
 * from the Punks website) beating the wings on an infinite loop.
 *
