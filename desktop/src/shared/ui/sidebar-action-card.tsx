...
function SidebarActionDescriptionText({
  ...
  if (shouldReduceMotion || !transition.isAnimating) {
    return (
      <span className="punks-sidebar-action-description">
        {transition.current}
      </span>
    );
  }
  ...
  return (
    <span className="punks-sidebar-action-description">
      ...
      <span aria-hidden className="punks-sidebar-action-description__motion">
        <span
          className="punks-sidebar-action-description__reel"
    ...
    >
      <button
        ...
        className={cn(
          ...
          isSuccess
            ? "punks-sidebar-action-card--success disabled:cursor-default disabled:opacity-100"
            : surface === "secondary"
      ...
      >
        ...
        <motion.span
          className={cn(
            ...
            isSuccess
              ? "punks-sidebar-action-card__success-icon"
