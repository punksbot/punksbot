...
function ImageBlock({ alt, dim, resolvedSrc, src, thumbSrc }: ImageBlockProps) {
  ...
  React.useLayoutEffect(() => {
    ...
    const spoiler = trigger.closest(".punks-spoiler[data-spoiler]");
    if (!spoiler) return;
...
export function createMarkdownComponents(
  ...
  function MarkdownAnchor({
    ...
    // Keep Punks channel/message navigation in-app.
    if (href) {
    ...
    // Valid Punks entity links navigate in-app; malformed links fall through.
    if (href) {
