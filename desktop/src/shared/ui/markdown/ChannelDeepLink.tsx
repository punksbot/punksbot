...
function ResolvedAuthoredDeepLink({
  ...
  if (!openable) {
    return (
      <span className="font-medium text-current" data-punks-link={href}>
        {children}
      </span>
    );
  }
...
/**
 * Renders an intentionally-labeled `punks-local://channel|message` deep link through
 ...
 * (`punks-local://channel/...` and `punks-local://message?...`) share this decision so a
