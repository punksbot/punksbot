...
import { useLocalWorkspaceRename } from "@/app/useLocalWorkspaceRename";
...
export function AppShell() {
  ...
  const handleUpdateCommunity = useLocalWorkspaceRename(communitiesHook);
  ...
  // Dispatch `punks-local://` deep links only from the main window; the companion is dedicated to its active Huddle route.
