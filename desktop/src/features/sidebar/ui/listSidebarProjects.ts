...
const SIDEBAR_PROJECTS_FILTER_KEY = "punks.sidebar.projects.filter";
const SIDEBAR_PROJECTS_SORT_KEY = "punks.sidebar.projects.sort";
const SIDEBAR_PROJECTS_EXPANDED_KEY = "punks.sidebar.projects.expanded";
