...
export function relayKlipyCapability(
  ...
  if (
    info.supported_extensions?.includes("punks-gif") === true &&
 ...
 * omitted until Punks has an explicit third-party ad surface.
 */
 ...
 * to the message body but deliberately omits an imeta tag, since Punks relays
