...
import { getPunksToolInfo } from "../agentSessionToolCatalog";
...
export function ToolItem({
  ...
  const canonicalToolName = item.punksToolName ?? item.toolName;
  const punksTool = getPunksToolInfo(canonicalToolName);
