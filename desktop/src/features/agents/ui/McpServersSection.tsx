...
type McpServersSectionProps = {
  ...
  punksAgentSlot?: React.ReactNode;
};
...
export function McpServersSection({
  ...
  const isPunksAgent = runtimeId === "punks-agent";
  ...
  return (
    ...
    >
      ...
      {isPunksAgent && punksAgentSlot ? punksAgentSlot : null}
