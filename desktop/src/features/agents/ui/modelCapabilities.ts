 ...
 * mirroring the Rust interpreter in `crates/punks-agent/src/model_capabilities.rs`
...
/** Valid thinking-effort values accepted by punks-agent (mirrors parse_thinking_effort in config.rs). */
