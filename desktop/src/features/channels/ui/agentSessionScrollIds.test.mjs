 ...
 *  tree transitively imports a .css file (PunksLogoAnimation.tsx →
 *  punks-logo-animation.css) and the test-loader has no CSS stub. The
...
// PunksLogoAnimation.tsx → punks-logo-animation.css). The test below verifies the
