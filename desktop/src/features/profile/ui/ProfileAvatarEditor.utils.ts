...
const EMOJI_MART_SHADOW_CSS = `
  ...
  #root {
    --padding: var(--punks-emoji-picker-padding, 16px);
    --punks-emoji-picker-search-control-height: 48px;
    --sidebar-width: 0px;
    display: flex;
  ...
  #root::after {
    background: linear-gradient(
      to bottom,
      rgba(var(--punks-emoji-picker-rgb-background), 0),
      rgba(var(--punks-emoji-picker-rgb-background), 0.98)
    );
    bottom: calc(var(--punks-emoji-picker-nav-button-size, 40px) + 24px);
    content: "";
    height: var(--punks-emoji-picker-fade-height, 0px);
    left: 0;
    opacity: var(--punks-emoji-picker-fade-opacity, 0);
    pointer-events: none;
    position: absolute;
    right: 0;
    z-index: 3;
  ...
  .scroll {
    ...
    padding-top: var(--punks-emoji-picker-scroll-padding-top, 28px);
    width: 100%;
  }
  ...
  .search input[type="search"] {
    border-radius: 12px;
    height: var(--punks-emoji-picker-search-control-height);
    padding-bottom: 0;
    padding-top: 0;
  }
  ...
  .search + .flex {
    border-radius: 12px;
    flex: 0 0 auto;
    height: var(--punks-emoji-picker-search-control-height) !important;
    margin-left: 8px;
    width: var(--punks-emoji-picker-search-control-height) !important;
  }
  ...
  .skin-tone-button {
    ...
    height: calc(var(--punks-emoji-picker-search-control-height) - 8px) !important;
    width: calc(var(--punks-emoji-picker-search-control-height) - 8px) !important;
  }
  ...
  .category button[data-punks-selected="true"] .background {
  ...
  #nav {
    ...
    flex: 0 0 auto;
    justify-content: space-between;
    padding: 8px var(--punks-emoji-picker-nav-padding-x, 24px) 16px;
  }
  ...
  #nav button {
    ...
    display: flex;
    flex: 0 0 var(--punks-emoji-picker-nav-button-size, 40px);
    height: var(--punks-emoji-picker-nav-button-size, 40px);
    justify-content: center;
    transition:
      background-color var(--duration) var(--easing),
      color var(--duration) var(--easing),
      transform var(--duration) var(--easing);
    width: var(--punks-emoji-picker-nav-button-size, 40px);
  }
  ...
  #nav svg,
  #nav img {
    height: var(--punks-emoji-picker-category-icon-size, 24px);
    width: var(--punks-emoji-picker-category-icon-size, 24px);
  }
`;
...
export function useEmojiMartStyles(
  ...
  React.useEffect(() => {
    ...
    const installEmojiMartStyles = () => {
      ...
      if (!shadowRoot.querySelector("#punks-emoji-mart-style")) {
        const style = document.createElement("style");
        style.id = "punks-emoji-mart-style";
...
export function useEmojiMartThemeVars() {
  ...
  React.useEffect(() => {
    const updateThemeVars = () => {
      ...
      setThemeVars({
        "--punks-emoji-picker-rgb-background": muted ?? "54, 58, 79",
        "--punks-emoji-picker-rgb-color": foreground ?? "245, 247, 255",
        "--punks-emoji-picker-rgb-input": input ?? "47, 51, 68",
