        ...
        {onRetry ? (
          <Button
            className={cn(
              ...
              compact &&
                "bg-[rgb(var(--punks-onboarding-avatar-accent-bg))] text-[rgb(var(--punks-onboarding-avatar-accent-fg))] hover:bg-[rgb(var(--punks-onboarding-avatar-accent-bg))]",
            )}
          ...
          <Button
            ...
            className={cn(
              compact
                ? "h-[2.375rem] rounded-full bg-[rgb(var(--punks-onboarding-avatar-action-bg))] px-6 text-sm font-medium text-[rgb(var(--punks-onboarding-avatar-action-fg))] hover:bg-[color:rgb(var(--punks-onboarding-avatar-action-bg)_/_0.9)]"
                : "h-12 w-full rounded-xl",
            )}
