...
const STORAGE_KEY = "punks-community-onboarding-transaction.v1";
...
export function markCommunityOnboardingComplete(
  ...
  storage.setItem(
    `punks-community-onboarding-complete.v1:${encodeURIComponent(relayUrl)}:${pubkey}`,
    "true",
  );
  ...
  storage.setItem(`punks-onboarding-complete.v1:${pubkey}`, "true");
}
