...
export const WELCOME_KICKOFF_OPENER_MARKER = "punks-welcome-kickoff.opener.v1";
export const WELCOME_KICKOFF_CLOSER_MARKER = "punks-welcome-kickoff.closer.v1";
export const WELCOME_KICKOFF_PROVIDER_MARKER =
  "punks-welcome-kickoff.provider-required.v1";
...
export function buildWelcomeKickoffOpener(
  ...
  if (introTeammates.length === 0) {
    ...
    return `${greeting} Welcome to Punks. This is your private home base, and I'm here${teammatePhrase} to help you get oriented or work through something you're building.\n\n${WELCOME_KICKOFF_CTA}`;
  }

  return `${greeting} Welcome to Punks. This is your private home base, and we're here to help you get oriented or work through something you're building.\n\n${introNames}, introduce ${introTeammates.length === 1 ? "yourself" : "yourselves"} in a sentence or two — share what you're good at and when to bring you in. Don't start any work yet.`;
}
  ...
  React.useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        // Start before publishing the mention. punks-acp replays events from its
