...
function isPunksRuntime(runtime: AcpRuntimeCatalogEntry): boolean {
  return runtime.id.trim().toLowerCase() === "punks-agent";
}

export function getRuntimeDisplayLabel(
  runtime: AcpRuntimeCatalogEntry,
): string {
  return isPunksRuntime(runtime) ? "Punks" : runtime.label;
}
...
export function RuntimeIcon({
  ...
  if (isPunksRuntime(runtime)) {
    ...
    return <PunksMark className={cn(className, "text-foreground")} />;
  }
