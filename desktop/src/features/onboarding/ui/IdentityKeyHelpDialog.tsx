...
const IDENTITY_KEY_HELP_SEEN_STORAGE_KEY =
  "punks.machine-onboarding.identity-key-help-seen.v1";
    ...
    <Dialog>
      ...
      >
        <div className="mx-auto w-full max-w-[35rem] py-14 text-left max-sm:py-6">
          ...
          <DialogDescription
            asChild
            className="mt-6 space-y-4 text-pretty text-base leading-7 text-[color:var(--punks-onboarding-backup-ink)]"
          >
            <div>
              <p>
                Punks uses an identity key instead of a traditional account.
                It’s created on your device and represents you whenever you use
                Punks.
              </p>
              <p>
                Your identity belongs to you, not Punks. There’s no password to
                reset, and Punks can’t recover your key if you lose it. Keep a
                backup somewhere safe and never share it. Anyone with your key
                can act as you.
              </p>
              <p>
                If you’re new to Punks, create a new identity key. If you
