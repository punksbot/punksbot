...
export function PendingInviteGate() {
  ...
  return (
    <div
      className="punks-onboarding-neutral-theme punks-startup-shell fixed inset-0 z-50 flex items-center justify-center bg-background px-4 py-8 text-foreground"
