...
export function OnboardingFlow({
  ...
  return (
    <>
      <div
        className="punks-onboarding-neutral-theme punks-startup-shell flex items-start justify-center overflow-y-auto bg-background px-4 pb-28 pt-[106px] text-foreground"
                  ...
                  {identityLost ? (
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Re-import your nsec to restore it — Punks will restart
                    ...
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Punks. If this key already has a profile on the relay,
