 ...
 * light-blue label (`--punks-onboarding-cta-label`, available on any
 * `.punks-onboarding-neutral-theme` subtree).
 */
export const ONBOARDING_PRIMARY_CTA_CLASS = `${ONBOARDING_CTA_SHAPE} text-[var(--punks-onboarding-cta-label)]`;
 ...
 * chartreuse label (`--punks-welcome-chartreuse`). The blue label is reserved
 * for the CTAs inside the steps.
 */
export const ONBOARDING_LANDING_CTA_CLASS = `${ONBOARDING_CTA_SHAPE} text-[var(--punks-welcome-chartreuse)]`;
 ...
 * olive backup ink (`--punks-onboarding-backup-ink`) with a plain
...
export const ONBOARDING_INK_ICON_CLASS =
  "text-[color:var(--punks-onboarding-backup-ink)] hover:bg-transparent hover:text-foreground";
 ...
 * static Punks mark pinned to the top-left, and a centered pagination track that
  ...
  return (
    ...
    >
      <span className="block w-11" data-testid="onboarding-logo">
        <PunksMark className="h-auto w-full" />
      </span>
      <div
