...
export function OnboardingSlideTransition({
  ...
  return (
    <div
      className={cn("punks-onboarding-slide w-full", containerClassName)}
      key={transitionKey}
      {...props}
    >
      <TransitionLine
...
function TransitionLine({
  ...
  return (
    <div
      className="punks-onboarding-transition-line flex w-full justify-center"
      data-onboarding-direction={direction}
      data-onboarding-effect={effect}
    >
      <div
        className={cn(
          "punks-onboarding-transition-content w-full",
          contentClassName,
        )}
      >
        {children}
