...
const SPOILER_SELECTOR = ".punks-spoiler[data-spoiler]";
...
function mountComposerSpoilerParticles(
  ...
  overlayRoot.className = "punks-spoiler-composer-particles";
  ...
  const mountSpoiler = (spoiler: HTMLElement) => {
    ...
    canvas.className =
      "punks-spoiler__particles punks-spoiler__particles--composer";
