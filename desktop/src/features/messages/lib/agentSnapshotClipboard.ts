...
const CLIPBOARD_ATTRIBUTE = "data-punks-agent-snapshot";
...
/** Build Punks-specific clipboard HTML with the raw URL as its visible link. */
...
/** Convert a Punks snapshot clipboard payload into one pending attachment. */
