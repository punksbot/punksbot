...
const SPOILER_MARKDOWN_RULE = "punks_spoiler";
const SPOILER_OPEN_TOKEN = "punks_spoiler_open";
const SPOILER_CLOSE_TOKEN = "punks_spoiler_close";
...
export function registerSpoilerMarkdownIt(
  ...
  md.renderer.rules[SPOILER_OPEN_TOKEN] = () =>
    '<span data-spoiler="" class="punks-spoiler">';
