/**
 * Relay push-policy denial token for a repository with no `punks-channel`
 * binding. Declared in Rust as `punks-core::git_perms::
...
const NO_CHANNEL_BINDING_COPY =
  ...
  "punks repos bind --id <repo> --channel <channel-uuid>";
