...
const taskA = selectionItemFromTask({
  ...
  channelId: "channel-1",
  id: "issue-a",
  shareLink: "punks-local://issue?id=a",
  title: "Fix login",
});
const taskB = selectionItemFromTask({
  ...
  channelId: "channel-1",
  id: "issue-b",
  shareLink: "punks-local://issue?id=b",
  title: "Fix logout",
});
const taskC = selectionItemFromTask({
  ...
  channelId: "channel-2",
  id: "issue-c",
  shareLink: "punks-local://issue?id=c",
  title: "Fix signup",
});
const commit = selectionItemFromCommit({
  ...
  commitHash: "abc",
  projectId: "punks",
  shareLink: "punks-local://commit?h=abc",
  title: "Ship the pod",
});
...
test("discuss content prefers share links and the majority channel", () => {
  ...
  assert.equal(
    ...
    "Let's talk about these tasks:\n\npunks-local://issue?id=a\npunks-local://issue?id=b",
  );
