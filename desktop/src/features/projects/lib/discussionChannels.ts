/**
 * "Discussed in" channel discovery for Punks git entities.
 *
 * Chat messages that reference a PR, issue, or repository do so only through
 * `punks-local://` links in their *content* — they carry no entity tags (see
 ...
 * of the search text, and `punks-local://` links tokenize into their query-param
