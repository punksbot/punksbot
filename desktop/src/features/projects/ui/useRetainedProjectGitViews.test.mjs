...
registerHooks({
  resolve(specifier, context, nextResolve) {
    if (specifier === "@/features/forum/ui/ForumComposer") {
      return { shortCircuit: true, url: "punks-pr-panel-stub:ForumComposer" };
    }
    return nextResolve(specifier, context);
  },
  load(url, context, nextLoad) {
    if (url === "punks-pr-panel-stub:ForumComposer") {
      return {
        format: "module",
        shortCircuit: true,
        source:
...
const repository = {
  ...
  name: "punks",
  description: "",
  cloneUrls: ["https://example.com/punks.git"],
  webUrl: null,
  owner: OWNER,
  contributors: [],
  createdAt: 0,
