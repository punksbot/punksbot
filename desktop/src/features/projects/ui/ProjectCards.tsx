...
function RepositoryUnavailableIndicator({
  ...
  const status = {
    authentication: {
      description: "Punks could not authenticate with this repository.",
      label: "Access failed",
    },
    missing: {
      description: "No git repository was found on the Punks relay.",
      label: "Uninitialized",
    },
    access: {
      description:
    ...
    network: {
      description: "The Punks git service could not be reached.",
      label: "Unreachable",
    },
    ref: {
    ...
    unknown: {
      description: "Punks could not load this repository.",
      label: "Unavailable",
    },
  } satisfies Record<
