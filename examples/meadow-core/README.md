...
A minimal three-agent persona pack for Punks.
...
```bash
# Validate the pack
punks pack validate ./examples/meadow-core

# Inspect resolved config
punks pack inspect ./examples/meadow-core
```
...
app), not persona-pack source. `punks pack inspect` above shows the fully-resolved per-agent
...
`crates/punks-persona/PERSONA_PACK_SPEC.md` for the current import paths.
...
See `crates/punks-persona/PERSONA_PACK_SPEC.md` for the full format reference.
