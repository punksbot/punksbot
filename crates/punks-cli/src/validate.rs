...
pub fn sdk_err(e: punks_sdk::SdkError) -> CliError {
    match e {
        punks_sdk::SdkError::InvalidInput(msg) => CliError::Usage(msg),
...
mod tests {
    ...
    // and `normalize_mention_pubkeys` live in `punks_sdk::mentions` and are tested there.
