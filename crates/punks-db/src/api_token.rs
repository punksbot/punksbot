...
mod tests {
    ...
    async fn lookup_by_hash_is_scoped_to_community() {
        ...
        let cid_a = punks_core::CommunityId::from_uuid(community_a);
        let cid_b = punks_core::CommunityId::from_uuid(community_b);
        ...
        let cid_c = punks_core::CommunityId::from_uuid(community_c);
        let from_c = db
