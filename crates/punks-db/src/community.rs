...
impl Db {
    ...
    /// request/connection error. punks-db only reads the durable host map.
    ...
    /// fully-formed [`punks_core::tenant::TenantContext`] — host included — to
    ...
    ///
    /// Used by the runtime conformance read-seam emitters in `punks-relay`:
