...
//!
//! punks-agent asks the client to authorize every LLM-issued MCP tool call
//! *before* executing it; the client applies `PUNKS_ACP_PERMISSION_POLICY` and
...
//!   (`PUNKS_AGENT_MAX_PENDING_PERMISSIONS`) acquired *before* any correlation
