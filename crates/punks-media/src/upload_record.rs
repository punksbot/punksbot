...
//! `PUNKS_MEDIA_UPLOAD_RECORDS`. IP collection is a second, independent opt-in
//! (`PUNKS_MEDIA_UPLOAD_IP_HEADER`) and is *fail-empty*: a missing, malformed,
...
//!
//! ## Consumer contract (punks-moderation)
//!
...
pub struct UploadRecord {
    ...
    /// Present only when `PUNKS_MEDIA_UPLOAD_IP_HEADER` is set AND the header
