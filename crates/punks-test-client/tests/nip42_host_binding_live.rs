...
//! # Run one binary, PUNKS_HEALTH_PORT=8180 PUNKS_METRICS_PORT=9202,
//! # PUNKS_RECONCILE_CHANNELS=false, PUNKS_GIT_CONFORMANCE_PROBE=false
//! ```
//!
//! Each test is `#[ignore]` so it only runs explicitly:
//! `cargo test -p punks-test-client --test nip42_host_binding_live -- --ignored --test-threads=1`
