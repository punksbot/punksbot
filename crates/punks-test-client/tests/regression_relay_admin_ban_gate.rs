...
//! (PUNKS-SEC-007 class, reported 2026-07-27).
//!
...
//!   DATABASE_URL=postgres://punks:punks_dev@localhost:5432/punks_relay_admin_regression \
//!   cargo test -p punks-test-client --test regression_relay_admin_ban_gate \
//!     -- --ignored --nocapture
