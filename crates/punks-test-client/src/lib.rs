...
//! Minimal NIP-01 WebSocket test client for the Punks relay.
...
use punks_ws_client::NostrWsConnection;
pub use punks_ws_client::{parse_relay_message, OkResponse, RelayMessage, WsClientError};

/// Errors returned by [`PunksTestClient`] operations.
#[derive(Debug, Error)]
...
/// WebSocket test client for integration testing against a running Punks relay.
pub struct PunksTestClient {
    inner: NostrWsConnection,
}

impl PunksTestClient {
