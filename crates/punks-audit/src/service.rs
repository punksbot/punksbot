...
const AUDIT_LOCK_NAMESPACE: &str = "punks_audit:";
...
mod tests {
    ...
    async fn test_pool() -> Option<PgPool> {
        let url = std::env::var("DATABASE_URL")
            .unwrap_or_else(|_| "postgres://punks:punks_dev@localhost:5432/punks".into()); // sadscan:disable np.postgres.1 -- local test fixture
