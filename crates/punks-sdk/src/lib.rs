#![deny(unsafe_code)]
#![warn(missing_docs)]
//! `punks-sdk` — typed Nostr event builders for Punks operations.
//!
//! # Mental Model
//!
//! ```text
...
/// Re-export kind constants so consumers don't need punks-core directly.
pub use punks_core::kind;
...
pub use punks_core::channel::canonical_channel_name;
/// Channel type.
pub use punks_core::channel::ChannelType as ChannelKind;
/// Channel visibility.
pub use punks_core::channel::ChannelVisibility as Visibility;
/// Member role.
pub use punks_core::channel::MemberRole;
