...
```bash
tamarin-prover --prove crates/punks-core/src/pairing/NIP-AB.spthy
```
...
Implementations MUST validate against these vectors. They can be reproduced with `punks-pair test-vectors`.
