//! Immutable capabilities for Punks Desktop's April Pocket TTS bundle.
...
/// Capabilities of Punks Desktop's sole Pocket model.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// Return immutable metadata for Punks Desktop's April INT8 model.
