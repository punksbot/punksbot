//! April 2026 Pocket TTS engine for Punks Desktop.
//!
...
//! Punks selects the upstream three-graph INT8 variant while retaining the
...
/// Load Punks Desktop's pinned April INT8 model.
...
mod tests {
    ...
    #[test]
    #[ignore = "requires PUNKS_POCKET_TEST_MODEL_DIR"]
    fn production_api_emits_non_silent_april_int8_pcm() {
        let dir = std::env::var("PUNKS_POCKET_TEST_MODEL_DIR")
            .expect("set PUNKS_POCKET_TEST_MODEL_DIR to an April INT8 model directory");
