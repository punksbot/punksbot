...
//! [`MeshStreamFrame::Data`](punks_relay_mesh::MeshStreamFrame). Their layout is
...
/// [`MeshStreamFrame::Data`](punks_relay_mesh::MeshStreamFrame)`.payload`,
...
mod tests {
    ...
    use punks_relay_mesh::{BoxFuture, StreamRecvHalf, StreamSendHalf};
    ...
    impl RelayPeerTransport for NullTransport {
        ...
        fn set_inbound(&self, _handler: Box<dyn punks_relay_mesh::InboundHandler>) {}
    }
