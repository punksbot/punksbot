#![deny(unsafe_code)]
#![warn(missing_docs)]
//! NIP-01 WebSocket relay for Punks private team communication.
...
/// `docs/spec/MultiTenantRelay.tla` by the independent `punks-conformance`
/// checker.
pub mod conformance;
...
/// Inter-relay mesh startup wiring (`PUNKS_MESH` seam).
pub mod mesh_boot;
...
/// Workflow action sink — relay-side implementation of [`punks_workflow::ActionSink`].
