...
//!
//! Crash report (2026-07-08, punks-desktop 0.3.46): enabling Share compute
...
//!
//!   cargo run -p punks-relay --example mesh_stack_smoke
...
/// Must match `punks_lib::mesh_llm::MESH_WORKER_STACK_SIZE` (desktop crate is
/// not a dependency of punks-relay, so the value is duplicated here).
