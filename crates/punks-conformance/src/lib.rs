...
/// trace schema.
///
/// This deliberately does NOT reuse `punks_core::CommunityId`. Two reasons:
///
/// 1. **Production fence preservation.** `punks_core::CommunityId` has no
...
impl CommunityLabel {
    /// Wrap a UUID into a community label. Unlike `punks_core::CommunityId`
