...
///   `str_ends_with`, `str_len` (duplicated intentionally from punks-workflow).
...
/// `str_len` — duplicated from punks-workflow intentionally so this crate
/// has no runtime dependency on punks-workflow.
