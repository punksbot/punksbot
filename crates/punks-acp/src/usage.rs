...
pub(crate) struct UsageUpdatePayload {
    ...
    #[serde(default)]
    pub pricing_identity: Option<punks_core::agent_turn_metric::PricingIdentity>,
}
...
pub(crate) struct UsageTracker {
    ...
    pending_identity: Option<Option<punks_core::agent_turn_metric::PricingIdentity>>,
...
mod tests {
    ...
    #[test]
    fn punks_agent_notification_flows_through_tracker() {
    ...
    #[test]
    fn punks_agent_payload_no_context_fields_processes_correctly() {
    ...
    fn make_pricing_identity_payload(
        ...
        UsageUpdatePayload {
            ...
            pricing_identity: Some(punks_core::agent_turn_metric::PricingIdentity {
