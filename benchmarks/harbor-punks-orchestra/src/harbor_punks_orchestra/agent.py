"""Harbor custom-agent entry point for Punks orchestration."""
...
from .container_runtime import EndpointLaunchConfig, PunksContainerRuntime
from .manifest import ExperimentManifest
from .provisioning import TrialProvisioner
from .runtime import OrchestraRuntime


class PunksOrchestraAgent(BaseAgent):
    """Coordinate an arbitrary manifest-defined team through a Punks trial."""
    ...
    def _build_runtime(
        ...
        punks_acp_binary: str,
        punks_agent_binary: str,
        punks_dev_mcp_binary: str,
        punks_cli_binary: str,
        relay_gateway: str,
        ...
        return PunksContainerRuntime(
            ...
            endpoints=endpoints,
            punks_acp_binary=punks_acp_binary,
            punks_agent_binary=punks_agent_binary,
            punks_dev_mcp_binary=punks_dev_mcp_binary,
            punks_cli_binary=punks_cli_binary,
    ...
    async def run(
        ...
        if self.provisioner is None or self.runtime is None:
            raise RuntimeError(
                "PunksOrchestraAgent requires provisioner and runtime integrations; "
        ...
        context.metadata = {
            **result.metadata,
            ...
            "punks_channel_id": handle.channel_id,
            "run_id": run_id,
            "trial_id": trial_id,
        }
