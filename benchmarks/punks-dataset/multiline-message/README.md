...
must survive the `punks messages send` shell call as real newline bytes. The
...
[punksbot/punksbot#5787](https://github.com/punksbot/punksbot/issues/5787).

Run with the command in the parent [README](../README.md), replacing the task
path with `benchmarks/punks-dataset/multiline-message`.
