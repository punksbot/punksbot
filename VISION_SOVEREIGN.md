# Punks — Your Project, Your Domain
...
Next to it, a "Connect on Punks" button.
...
You hit "Connect on Punks" and the app opens. You're in `#general`. The team is
...
"Connect on Punks" and they're in the community. No separate onboarding flow. No
...
portable even when the hosting isn't. And you can use Punks as a collaboration
layer on top of GitHub if that's what makes sense — work in Punks channels, push
...
Someone picks up the bug. They create a branch. Punks creates a channel:
...
things are announcements. Some things are essays. Punks has surfaces for both,
...
Onboarding friction is real — not insurmountable, but real. The "Connect on Punks"
