...
Ces règles Punks remplacent toute instruction Buzz contradictoire plus bas dans
ce fichier :

- le backend et ses tests utilisent uniquement les services Cloudflare Workers
  gérés et les implémentations `workerd` ;
- ne jamais démarrer le relay Buzz, Docker, PostgreSQL, Redis, MinIO, Helm,
...
- le guide Buzz conservé ci-dessous est une source historique pour la parité et
