...
DB_HOST="${PUNKS_DB_HOST:-127.0.0.1}"
DB_PORT="${PUNKS_DB_PORT:-5432}"
DB_USER="${PUNKS_DB_USER:-punks}"
DB_PASS="${PUNKS_DB_PASS:-punks_dev}"
DB_NAME="${PUNKS_DB_NAME:-punks}"
DB_DOCKER_CONTAINER="${PUNKS_DB_DOCKER_CONTAINER:-punks-postgres}"
...
COMMUNITY_HOST="${PUNKS_COMMUNITY_HOST:-localhost:3000}"
...
UUID_GENERAL=$(uuid5_hex "punks.channel.general")
UUID_RANDOM=$(uuid5_hex "punks.channel.random")
UUID_ENGINEERING=$(uuid5_hex "punks.channel.engineering")
UUID_AGENTS=$(uuid5_hex "punks.channel.agents")
UUID_WATERCOOLER=$(uuid5_hex "punks.channel.watercooler")
UUID_ANNOUNCEMENTS=$(uuid5_hex "punks.channel.announcements")
UUID_DM_ALICE_TYLER=$(uuid5_hex "punks.channel.dm.alice-tyler")
UUID_DM_BOB_TYLER=$(uuid5_hex "punks.channel.dm.bob-tyler")
UUID_DM_BOB_CHARLIE_TYLER=$(uuid5_hex "punks.channel.dm.bob-charlie-tyler")
