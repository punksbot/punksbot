...
[[ "$repo" == "punksbot/punksbot" ]] || fail "candidate publishing is restricted to punksbot/punksbot"
...
message="Punks Mobile $version release candidate $candidate_number"
tag_object_sha="$(
...
printf 'Published %s at %s through punks-release-bot.\n' "$tag" "$target_sha"
