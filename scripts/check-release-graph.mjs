 ...
 *     interdiction de retour Punks, immuabilité R2) ne peut pas dériver des
 *     décisions closes ;
...
export function main() {
  ...
  console.log(
    `✓ graphe de release : ${releases.length} candidat(s) relié(s), ${scellees} scellé(s), promotion immédiate par preuves, politique 90 j / < 1 % / 14 j et interdiction de retour Punks vérifiées`,
  );
