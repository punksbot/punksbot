...
const bool mockDmDirectoryEnabled =
    kDebugMode && bool.fromEnvironment('PUNKS_MOCK_DM_DIRECTORY');
...
///
/// Punks relays use `member` tags, while older NIP-29-compatible relays may
