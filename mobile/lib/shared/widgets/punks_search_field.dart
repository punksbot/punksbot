...
/// Height of an idle [PunksSearchField].
const double punksSearchIdleFieldHeight = 45;

/// Font size used for idle [PunksSearchField] text.
const double punksSearchIdleTextSize = 15;
...
/// Punks's global-search text field treatment, shared by search-like inputs.
class PunksSearchField extends StatelessWidget {
  /// Creates a search field with Punks's shared styling.
  const PunksSearchField({
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: searchInputTextStyle.copyWith(
                    ...
                    fontSize: punksSearchIdleTextSize,
                    height: 20 / punksSearchIdleTextSize,
                  ),
