...
class CommunityThemeStorage {
  static const _prefix = 'punks-community-theme.v1';
  static const _outboxPrefix = 'punks-community-theme-outbox.v1';
  static const _migrationPrefix = 'punks-community-theme-migrated.v1';
  static const _legacyModeKey = 'punks_theme_mode';
  static const _legacyAccentKey = 'punks_accent_color';
  static const _legacySchemeKey = 'punks_color_scheme';
  ...
  CommunityThemePreference legacyPreference() {
    ...
    final theme = findTheme(storedTheme ?? 'punks')?.name ?? 'punks';
