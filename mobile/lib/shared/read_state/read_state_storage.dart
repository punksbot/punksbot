...
const _clientIdKeyPrefix = 'punks.nip-rs.client-id';
const _slotIdKeyPrefix = 'punks.nip-rs.slot-id';
const _uuid = Uuid();

String localReadStateKey(String pubkey) => 'punks.channel-read-state.v2:$pubkey';

String localPublishableContextKey(String pubkey) =>
    'punks.channel-read-state.publishable.v1:$pubkey';

String localSourceCreatedAtKey(String pubkey) =>
    'punks.channel-read-state.source-created-at.v1:$pubkey';
