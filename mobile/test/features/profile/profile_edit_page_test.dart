...
import 'package:punks/features/profile/profile_avatar_crop_page.dart';
import 'package:punks/features/profile/avatar_background_grid.dart';
import 'package:punks/features/profile/avatar_editor_option_button.dart';
import 'package:punks/features/profile/animated_avatar_capture.dart';
import 'package:punks/features/profile/emoji_avatar_tile.dart';
import 'package:punks/features/profile/image_avatar_capture.dart';
import 'package:punks/shared/widgets/immediate_page_route.dart';
import 'package:punks/features/profile/profile_provider.dart';
import 'package:punks/shared/emoji/emoji_avatar.dart';
...
import 'package:punks/shared/widgets/ios_native_segmented_control.dart';
import 'package:punks/shared/widgets/ios_glass_navigation_button.dart';
import 'package:punks/shared/widgets/playing_avatar_image.dart';
import 'package:punks/shared/widgets/progressive_animated_avatar.dart';
...
void main() {
  ...
  testWidgets('shows profile fields and saves each one from a sheet', (
    ...
    expect(find.text('Building Punks'), findsOneWidget);
  ...
  testWidgets('keeps the local animation visible after profile Save', (
    ...
    expect(notifier.savedAvatarUrls.single, contains('#punks-anim='));
  });
