...
import 'package:punks/features/channels/agent_activity/observer_models.dart';
import 'package:punks/features/channels/agent_activity/transcript_builder.dart';
...
void main() {
  ...
  test('normalizes punks tool calls and applies result updates', () {
    final items = buildTranscript([
      _updateFrame(
        seq: 1,
        update: {
    ...
    expect(tool.punksToolName, 'send_message');
  ...
  test('parses punks prompt text into user message and metadata', () {
    final items = buildTranscript([
      ObserverFrame(
        seq: 1,
