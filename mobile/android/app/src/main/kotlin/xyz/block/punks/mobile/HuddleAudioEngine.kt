package xyz.block.punks.mobile
...
internal class HuddleAudioEngine(
    ...
    fun start() {
        ...
        running.set(true)
        captureThread = thread(name = "punks-huddle-capture", isDaemon = true) {
            runCapture(record, encoder)
        }
        playbackThread = thread(name = "punks-huddle-playback", isDaemon = true) {
            runPlayback()
        }
    }
