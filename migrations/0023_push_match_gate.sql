...
--     (crates/punks-db/src/push.rs: accept_lease_event and replace_lease).
...
--   * Lock key domain 'punks_push_gate:' is distinct from the audit lock
--     ('punks_audit:') and both lease-address lock families.
