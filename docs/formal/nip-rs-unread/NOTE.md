...
tags: [nostr, nip-rs, read-state, formal-model, punks]
status: active
created: 2026-07-16
---
...
(below): every context ID Punks actually generates (channel UUID,
...
**Cost:** zero bytes for every context ID Punks generates today (channel
...
">256-byte key drop hazard" section: Punks's own key shapes cannot
